...
export const MASCOT_BUBBLE_TONES = ['default', 'reward', 'tip', 'levelUp', 'thinking', 'disappointed'];
...
/** Visual stage themes for coach windows — one per mascot personality. */
export const MASCOT_STAGE_IDS = ['flip', 'flo', 'fins'];

export function getMascotStageId(mascotId) {
  return MASCOT_STAGE_IDS.includes(mascotId) ? mascotId : 'flip';
}
